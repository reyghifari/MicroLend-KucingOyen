...
fun DashboardScreen(
    ...
    Scaffold(
        ...
        when(selectedBar){
            ...
            1 -> {
                PortfolioScreen(dashboardViewModel, onClickRequestLoan = onClickRequestLoan, onClickFundLoan = onClickFundLoan, onClickFundedDetail = onClickFundedDetail, onClickLoanDetail = onClickLoanDetail)
            }
            2 -> {
